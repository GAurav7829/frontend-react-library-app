    ...
    <div>
      <div className="d-none d-lg-block">
        ...
        <div className="row g-0">
          <div className="col-4 col-md-4 container d-flex justify-centent-center align-item-center">
            <div className="ml-2">
              ...
              <p className="lead">
                ...
                possible for our Luv 2 Read students! We are dililgent about our
                book collections and our books are always
      ...
      <div className="d-lg-none">
        <div className="container">
          <div className="m-2">
            <div className="col-image-lefy"></div>
            <div className="mt-2">
              <h1>What have you been reading?</h1>
              <p className="lead">
                The library team would love to know what you have been reading.
